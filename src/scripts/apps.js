...
// import environment from '../static/photo_studio_broadway_hall_2k.hdr';
// import environment from '../static/cannon_2k.hdr';
// import environment from '../static/studio_small_03_2k.hdr';
// import environment from '../static/venice_sunset_4k.hdr';
// import environment from '../static/kloppenheim_05_4k.pic';
// import environment from '../static/aft_lounge_4k.pic';
// import environment from '../static/hall_of_finfish_1k.pic';
...
export default class Sketch {
  ...
  addObjects() {
    ...
    const font = new THREE.Font( theFont );
    ...
    for ( let i = 0; i<textToShow.length; i++) {
      ...
      const glyphGeometry = new THREE.TextGeometry( textToShow[ i ], {
        font: font,
        size: 10,
        height: 1,
        curveSegments: 3,
    ...
    .load( environment, function ( texture ) {
      ...
      // that.loader.preload();
      // that.loader.load( dracoModel, function( geometry ) {
      ...
      that.loader.load( metropolisModel, function ( gltf ) {
        ...
        // set the material otherwise lights not work
        // see https://threejs.org/examples/?q=gltf#webgl_loader_gltf
        // for advanced environment map example
